...
describe("smoke: tool registration (no live network)", () => {
  it("registerAllTools registers full verification inventory", () => {
    ...
    // 94 tools: 92 prior + switch_quote + switch_prepare_swap (v0.1.42)
    ...
    // Exact family counts: 3 health + 27 chain + 50 analytics + 14 wallet = 94
    ...
    expect(analytics.length).toBe(11 + 9 + 8 + 6 + 11 + 5);
